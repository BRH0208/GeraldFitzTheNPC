...
{
	public class Cannonade : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Mortar Triple Cannon"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			Tooltip.SetDefault("This is a simple and Crude triple artillery weapon");
		}
		...
		public override void AddRecipes() 
		{
			...
			recipe.AddIngredient(ItemType<Cannon>(),1);

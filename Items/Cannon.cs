...
namespace GeraldFitzTheNPC.Items
{
	public class Cannon : ModItem
	{
		...
		{
			DisplayName.SetDefault("Mortar Cannon"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			Tooltip.SetDefault("This is a simple and Crude artillery weapon");
		}
